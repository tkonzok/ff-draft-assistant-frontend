...
export class SettingsService {
  ...
  private selectedSettingSubject: BehaviorSubject<string> = new BehaviorSubject<string>('');
  private availableSettingsSubject: BehaviorSubject<string[]> = new BehaviorSubject<string[]>([]);

  constructor(private http: HttpClient) {
    this.http
      .get<Settings>(SettingsService.SETTINGS_URL)
      .pipe(
